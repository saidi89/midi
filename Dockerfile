FROM debian
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt install ssh curl screen wget npm apache2 php php-curl php-cli php-fpm php-json php-common php-mysql php-zip php-gd php-mbstring  php-xml php-pear php-bcmath  -y
